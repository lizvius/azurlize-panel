...
export const LandingPage = ({ onOpenAuth, isDark }: LandingPageProps) => {
        ...
        <div id="landing-page" className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0F19] text-gray-900 dark:text-gray-100 transition-colors duration-300 relative overflow-x-hidden">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 text-center relative z-10">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        >
                            Pelajari Alur Kerja <i className="ph-bold ph-arrow-down text-lg"></i>
                        </button>
                    </div>
                </div>
            </section>
            ...
            <section id="alur-kerja" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-gray-200/50 dark:border-gray-800/50 relative z-10 scroll-mt-20">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xl mx-auto font-medium">Langkah demi langkah sistematis rekrutmen dan koordinasi harian yang dijalankan oleh seluruh tim AzurLize.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {landingData.steps.map((step: WorkflowStep, index: number) => (
                        <div key={step.id || index} className="bg-white dark:bg-gray-800/40 backdrop-blur-md border border-gray-200/80 dark:border-gray-800/80 rounded-2xl p-6 shadow-sm hover:border-indigo-500/50 transition-all group duration-300">
                            ...
                            <h3 className="font-black text-lg text-gray-900 dark:text-white mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{step.title}</h3>
                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 leading-relaxed font-medium">{step.desc}</p>
                        </div>
                    ))}
                </div>
            </section>
